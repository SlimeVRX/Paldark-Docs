...
| [UEFN vs UE](https://dev.epicgames.com/documentation/en-us/fortnite/uefn-vs-ue-in-unreal-editor-for-fortnite) | UEFN là UE được tùy biến cho Fortnite; gameplay Blueprint visual scripting không có, Verse và Fortnite client giữ vai trò riêng. | UEFN là reference/lab, không phải target để convert KYWorld Blueprint hoặc thay UE5.8.1 C++. `[Inference]` |
| [UEFN MCP](https://dev.epicgames.com/documentation/fortnite/uefn-mcp) và [Unreal MCP 5.8](https://dev.epicgames.com/documentation/unreal-engine/unreal-mcp-in-unreal-editor) | MCP nhúng server trong Editor, quảng bá typed toolsets và hỗ trợ Verse/device/entity/session hoặc UE toolset tùy host. | MCP là observation/control plane; custom converter phải trả structured evidence và không được coi tool response là parity oracle. `[Inference]` |
| [Scene Graph](https://dev.epicgames.com/documentation/fortnite/scene-graph-in-unreal-editor-for-fortnite) | Entity/component/prefab tạo composition model Verse-native; feature hiện ở Beta. | Học composition, definition/instance và lifecycle; không thay Actor/ActorComponent bằng Scene Graph Beta. `[Inference]` |
| [Asset reflection](https://dev.epicgames.com/documentation/fortnite/exposing-assets-with-asset-reflection-to-verse-in-unreal-editor-for-fortnite) | UEFN sinh Assets.digest.verse để đưa asset được hỗ trợ thành compiler symbol. | Paldark sinh deterministic Blueprint semantic digest có provenance thay vì để agent đoán binary content. `[Inference]` |
| [Validation and Fix-Up](https://dev.epicgames.com/documentation/fortnite/validation-and-fixup-tool-in-unreal-editor-for-fortnite) | UEFN kiểm type/property/reference, platform, cook và memory trước upload và trên server; fix-up có report/undo. | Conversion phải fail-closed qua closure/build/load/package gates; auto-fix chỉ ở staging, có receipt và rollback. `[Inference]` |
| [Lore best practices](https://dev.epicgames.com/documentation/fortnite/lore-version-control-best-practices-in-unreal-editor-for-fortnite) | Epic khuyến cáo một source of truth và không bật nhiều version-control/backup system cho cùng project/location. | `UEFNPaldark` phải chọn Lore hoặc Git policy trước team editing; không để hai hệ cùng âm thầm sở hữu binary assets. `[Inference]` |
