...
Ba quyển vừa rồi trả lời ba câu: game này vui ở đâu, vì sao đông người thì codebase vỡ, và bộ khung nào chống vỡ. Quyển 4 làm việc còn lại: **dùng bộ khung đó dựng lại từng hệ thống của Palworld.**

Mười lăm chương sau đây đều theo cùng một khuôn. Chương này giới thiệu khuôn đó, rồi áp nó lần đầu cho hệ thống nền.

## 20.1 — Khuôn của mỗi chương

Mỗi chương từ 21 tới 35 có bảy mục, luôn theo thứ tự này:
...
Bảy mục này không phải một bản mẫu hành chính. Chúng là bảy câu hỏi mà nếu trả lời được hết thì một agent khác đọc xong có thể viết code, còn nếu bỏ sót một câu thì agent đó sẽ phải đoán — và mỗi lần đoán là một lần hai agent đoán khác nhau.

## 20.2 — Thứ tự dựng, và vì sao là thứ tự đó

Mười lăm chương không xếp theo mức độ quan trọng, mà xếp theo **thứ tự có thể chơi được**. Nguyên tắc: sau mỗi chương, phải có thêm một thứ bấm được và nhìn thấy được.
...
Ba chỗ trong thứ tự này đáng giải thích, vì nếu không nói thì người đọc sẽ thấy nó tùy tiện:
...
Nền không có mục "vì sao tồn tại" theo nghĩa cảm giác người chơi, vì người chơi không bao giờ thấy nó. Lý do nó tồn tại là: **để mười lăm chương sau đều bắt đầu từ cùng một chỗ.**
...
Không có gì trong bảng này là mới. Chương này chỉ gom chúng lại thành một danh sách công việc, vì đây là **phần duy nhất trong cả dự án không song song hóa được** — phải xong trước khi một nghìn agent bắt đầu.
...
Nền xong khi và chỉ khi làm được ba việc sau mà không sửa một dòng nào của bốn module khung:
...
Ba việc này chính là ba khuôn mẫu ở Chương 6 được kiểm chứng bằng cách chạy thật. Nếu cả ba chạy, bộ khung đứng được. Nếu một trong ba đòi phải sửa module khung, ta chưa xong và không nên cho ai bắt đầu.

Đây cũng sẽ là nội dung của lát cắt đầu tiên trong `PaldarkKit`.

## 20.4 — Điều cần nói trước khi vào mười lăm chương

Thứ tự triển khai thực tế có một điều chỉnh: Chương 33 — Lưu trữ được đọc
